                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="header">
                                            <h4 class="title">USERS PROFILE - USERS ACTIVITY</h4>
                                        ...
                                        <div class="content table-responsive table-full-width">
                                            <table class="table table-hover table-striped">
                                                ...
                                                <th>ID</th>
                                                <th>User Name</th>
                                                <th>Last time login ( timestamp- GMT +00:00 ) </th>
                                                <th>Date Register ( timestamp- GMT +00:00 )</th>
                                                <th>  </th>
                                                <th>  </th>
                                                <th> </th>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    for ($i = 0; $i < $size; $i++)
                                                    {
                                                        ...
                                                        echo "<td>" . $print = isset($LastTimeLogin[$i]) ? $LastTimeLogin[$i] : "--" . " </td>";

                                                        echo "<td>$UserDateRegister[$i] </td>";
...
<?php
if (isset($newUserIntoSystem))
{
    echo "Materialize.toast('New User has being created succesfully!', 5000, 'green rounded');";
}
?>
