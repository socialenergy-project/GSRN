                                                            ...
                                                            <table class="table table-hover table-striped responsive-table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    for ($i = 0; $i < $max; $i++)
                                                                    {
                                                                        ...
                                                                        echo "<td><div id='Sub_$i'>$label</div></td>";
                                                                        echo "<td><button type='submit' class='btn btn-info btn-fill gameActi' id='previewID' data-id='$timestamp[$i]' data-idu='$userID[$i]' style=' margin-left:-65px;'>Preview</button></td>";
                                                                        echo "<td><button type='submit' class='btn btn-info btn-fill gameActiau' id='authorizeID' data-idit='$i' data-id='$timestamp[$i]' data-idu='$userID[$i]' data-ids='$status[$i]' style=' margin-left:-65px;background:red;'>Authorize</button></td>";
                                                                        echo "</tr>";
                                                                    }
                                                                    ?>
...
<?php $this->view('extra/jslib'); ?>
                                    ...
                                    $(".gameActiau").click(function () {


                                        var iter = $(this).attr("data-idit");
                                        var status = $(this).attr("data-ids");
                                        var thisC = $(this);
                                        $.ajax({
                                            type: "POST",
                                            url: "<? echo site_url('Marketplaceorderstatus2/asuthCont'); ?>",
                                            dataType: 'json',
                                            cache: false,
                                            data: {
                                                dataids: $(this).attr("data-ids"),
                                                dataidu: $(this).attr("data-idu"),
                                            ...
                                            success: function (msg) { //probably this request will return anything, it'll be put in var "data"
                                                ...
                                                if (msg.result == 200) {
                                                    ...
                                                    if (status == 0) {
                                                        $(thisC).text("REMOVE");
                                                        $(thisC).attr('value', 'Save');
                                                        $('#Sub_' + iter).text("Approved");
                                                        thisC.attr('data-ids', '1');
                                                        Materialize.toast('Order has being Approved!', 4000, 'green rounded');
                                                    } else {
                                                         $(thisC).text("AUTHORIZE");
                                                         $('#Sub_' + iter).text("Pending");
                                                         thisC.attr('data-ids', '0');
                                                         Materialize.toast('Order has being removed!', 4000, 'green rounded');
                                                    }
                                                    ...
                                                    Materialize.toast('Please try again later!', 4000, 'green rounded');
                                                }
                                    ...
                                    $(".gameActi").click(function () {
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: "<? echo site_url('Marketplaceorderstatus2/loadCont'); ?>",
                                            dataType: 'json',
                                            cache: false,
                                            data: {
                                                dataidu: $(this).attr("data-idu"),
