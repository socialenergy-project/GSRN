                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    ...
                                    <div class="content">
										<?php
										echo form_open('adduser/saveuser');
										?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="Username_1" id="Username_1" class="form-control" placeholder="Username" 
														   <?= $value = isset($Username_1) ? "value='" . $Username_1 . "'" : "value=''"; ?> >
														   <?= form_error('Username_1'); ?>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email_1" id="email_1" class="form-control" placeholder="Email"
														   <?= $value = isset($email_1) ? "value='" . $email_1 . "'" : "value=''"; ?>>
														   <?= form_error('email_1'); ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" name="password_1" id="password_1" class="form-control" placeholder="Password" 
														   <?= $value = isset($password_1) ? "value='" . $password_1 . "'" : "value=''"; ?>>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="firtName_1" id="firtName_1" class="form-control" placeholder="Company" value="John" value="">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Last Name</label>
                                                    <input type="text" name="lastName_1" id="lastName_1" class="form-control" placeholder="Last Name" value="Papas" value="">
                                                </div>
                                            </div>
                                        </div>
											...
											<div class="col-md-6">
                                                <div class="form-group">
													<div class="switch">
														<label>
															Admin
															<input type="checkbox" name="userLevelC" id="userLevelC" checked='checked' >
															<span class="lever"></span>
															User
														</label>
														<?= form_error('userLevelC'); ?>
													</div>                                            
												</div>
                                            </div>  
										...
										<div class="row">
											<div class="col-md-6">
                                                <div class="form-group">
													...
													<p >
														<input  type="checkbox" id="escoUser" name="escoUser" <?= $checked ?> value="On" />
														<label for="escoUser" class="tooltipped" data-position="bottom" data-tooltip="Esco User has access only to markeplace!">Esco User</label>
													</p>
												</div>
											</div>
										</div>
...
$('#escoUser').change(function() {

$('#userLevelC').prop('checked', true);
//escoUser
});
