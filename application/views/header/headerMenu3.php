    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <!-- <a class="navbar-brand" href="#">Table List</a>
			 ...
			 <p class="navbar-brand" href="#">Tips: </p>  <span id="js-rotating" class="navbar-brand" style="word-wrap:break-word;max-width:900px;height:50px;overflow-wrap:break-word;font-size:16px;overflow:hidden;"></span>
			
			
			-->  
			
			<div class="col s1">
                      <a class="navbar-brand" href="#modalnrec2C" id="modalnrec2C"><i class="material-icons">notifications</i></a>  
  
			
			<span id="js-rotating" class="navbar-brand" style="word-wrap:break-word;max-width:350px;height:30px;font-size:14px;overflow:hidden;"><?= implode(",", $ActiveTips); ?></span>
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
				...
				<!--
				<li>
					<a  href="#modalnrec2C" id="modalnrec2C"><i class="ti-bell"></i>
                ...
                <li>
					...
					echo anchor('login/logout', '
                                    <p style="font-size:13px;">Log out: ' . $priUsr . '</p>', 'class="link-class"')
					?>  
