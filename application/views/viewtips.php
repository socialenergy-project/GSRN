                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="header">
                                            <h4 class="title">Notifications list - Notifications Activity</h4>
                                            <p class="category">View Users Activity!</p>
                                        </div>
                                        <div class="content table-responsive table-full-width">
                                            <table class="table table-hover table-striped">
                                                ...
                                                <th>ID</th>
                                                <th>Message</th>
                                                <th>Message deploys at: ( timestamp- GMT +00:00 ) </th>
                                                <th>Message finished at:( timestamp- GMT +00:00 )</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    for ($i = 0; $i < $size; $i++) {
                                                        ...
                                                        echo "<td> 1 </td>";
                                                        echo "<td>$descM[$i] </td>";
                                                        echo "<td>$dateFrom[$i] </td>";
                                                        echo "<td>$dateTo[$i] </td>";
                                                        echo "<td> --- </td>";
                                                        echo "<td> --- </td>";
                                                        echo "<td> <button type='submit' class='btn btn-info btn-fill ' id='previewID' data-id='$UserID[$i]' style=' margin-left:-65px;'>Preview</button> </td>";
...
<?php
if (isset($newTipIntoSystem)) {

    echo "Materialize.toast('New Tip has being created succesfully!', 5000, 'green rounded');";
}
?>
