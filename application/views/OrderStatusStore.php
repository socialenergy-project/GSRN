                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="header">
                                        <h4 class="title">GAME PROFILE!</h4>
                                    </div>
                                    <div class="content">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="card">
                                                        <div class="header">
                                                            ...
                                                            <p class="category">Learning object finished!</p>
                                                        </div>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    for ($i = 0; $i < $max; $i++)
                                                                    {
                                                                      ...
                                                                      echo "<td> " . date("d/m/Y h:i:s", $timestamp_user_logged_in[$i] + $game_duration[$i]) . " </td>";
                                                                        ...
                                                                        echo "<td><button type='submit' class='btn btn-info btn-fill gameActi' id='previewID' data-id='$Row_id[$i]' data-json='$devices[$i]' data-timestr='" . date("d/m/Y h:i:sa", $timestamp_user_logged_in[$i]) . "' style=' margin-left:-65px;'>Preview</button></td>";
                                                                        echo "</tr>";
                                                                    }
                                                                    ?>
