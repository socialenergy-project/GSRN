...
//  $array[] = "Choose your option";
                                                            ...
                                                            llllllllllllllllllllllllllll 333333333333333333333333333333    
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-10">
                                                                    <div class="form-group">
                                                                        <label>8) Do you have renewable energy resources (RES) installed at your house?</label>                          
                                                                        ...
                                                                        <div class="switch">
                                                                            <label>
                                                                                Yes
                                                                                <input type="checkbox" name="dyhreriah1" id="dyhreriah1" <?= $checked ?>>
                                                                                <span class="lever"></span>
                                                                                No
                                                                            </label>
                                                                            <?= form_error('dyhreriah1'); ?>
                                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-11">
                                                                    <div class="form-group">
                                                                        <label> 9) In case of yes, please indicate the type of RES that you have?</label>                          
                                                                        <div class="switch">

                                                                            <?php
//echo "<br>-486--$ipinttrtuh---";
                                                                            $checked = "";

                                                                            if (isset($ipinttrtuh))
                                                                            {
                                                                                if ($ipinttrtuh == "Other (Free text)")
                                                                                {
                                                                                    $checked = "checked='checked'";
                                                                                }
                                                                            }
                                                                            ...
                                                                            <label>
                                                                                Photovoltaic in Roof
                                                                                <input type="checkbox" name="ipinttrtuh" id="ipinttrtuh" <?= $checked ?>>
                                                                                <span class="lever"></span>
                                                                                Other (Free text)
                                                                            </label>
                                                                            <?= form_error('ipinttrtuh'); ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>      
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-8">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-field col s12">                                
                                                                            <select name="ifhecfhov1" id="ifhecfhov1">
                                                                                ...
                                                                                for ($i = 0; $i < $max; $i++)
                                                                                {
                                                                                    ...
                                                                                    if (isset($ifhecfhov) && ($ifhecfhov == $array[$i]))
                                                                                    {
                                                                            ...
                                                                            <label>10) If you have an energy certificate for your home, please select overall  class:</label>
                                                                            <?= form_error('ifhecfhov'); ?>
                                                                            <input type="hidden" name="ifhecfhov" id="ifhecfhov" />
                                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label>11) If you have an energy certificate for your home, please fill the Primary Efficiency Index (kwh/m2 year)</label>

                                                                        <input type="text" name="primaryEfficIndex" id="primaryEfficIndex" class="form-control" placeholder="kwh/m2 year" <?= $value = isset($primaryEfficIndex) ? "value='" . $primaryEfficIndex . "'" : "value=''"; ?>>
                                                                        <?= form_error('primaryEfficIndex'); ?>
                                                                        <p>

                                                                            <?php
                                                                            $checked = "";

                                                                            if (isset($enecerpeddindont))
                                                                            {
                                                                                if ($enecerpeddindont == "Don’t know")
                                                                                {
                                                                                    $checked = "checked='checked'";
                                                                                }
                                                                            }
                                                                            ...
                                                                            <input type="checkbox" name="enecerpeddindont" value="Don’t know" id="enecerpeddindont"  <?= $checked ?>/>
                                                                            <label for="enecerpeddindont">Don’t know</label>
                                                                            <?= form_error('enecerpeddindont'); ?>
                                                                        </p>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                $checked_2 = "";
                                                                $checked_3 = "";
                                                                if (isset($typeaircond))
                                                                {
                                                                    if ($typeaircond == "Individual cooling")
                                                                    {
                                                                        $checked_1 = "checked";
                                                                    }
                                                                    elseif ($typeaircond == "Central cooling")
                                                                    {
                                                                        $checked_2 = "checked";
                                                                    }
                                                                    elseif ($typeaircond == "No air-conditioning")
                                                                    {
                                                                        $checked_3 = "checked";
                                                                    }
                                                                }
                                                                ...
                                                                <div class="col-md-13">
                                                                    <div class="form-group">
                                                                        <label>12) Please select the type of air-conditioning </label>

                                                                        <p>
                                                                            <input name="typeaircond" type="radio" id="indci_cooling" value="Individual cooling" <?= $checked_1; ?>/>
                                                                            <label for="indci_cooling">a. Individual cooling </label>
                                                                        </p>
                                                                        <p>
                                                                            <input name="typeaircond" type="radio" id="central_cooling" value="Central cooling" <?= $checked_2; ?>/>
                                                                            <label for="central_cooling">b. Central cooling</label>
                                                                        </p>
                                                                        <p>
                                                                            <input  name="typeaircond" type="radio" id="noair_cond" value="No air-conditioning" <?= $checked_3; ?>/>
                                                                            <label for="noair_cond">c. No air-conditioning</label>
                                                                        </p>

                                                                        <?= form_error('typeaircond'); ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-11">
                                                                    <div class="form-group">
                                                                        <div class="input-field col s12">                                
                                                                            <select name="energyclassacu_21" id="energyclassacu_21">
                                                                                ...
                                                                                for ($i = 0; $i < $max; $i++)
                                                                                {
                                                                                    ...
                                                                                    if (isset($energyclassacu_2) && ($energyclassacu_2 == $array[$i]))
                                                                                    {
                                                                            ...
                                                                            <label>13) Please select the energy class of your AC unit:</label>
                                                                            <?= form_error('energyclassacu_2'); ?>
                                                                            <input type="hidden" name="energyclassacu_2" id="energyclassacu_2" />
                                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-11">
                                                                    <div class="form-group">
                                                                        <label> 14) Do you have washing machine?</label>    

                                                                        <?php
// echo "<br>-486--$doyhwasmach---";
                                                                        $checked = "";

                                                                        if (isset($doyhwasmach))
                                                                        {
                                                                            if ($doyhwasmach == "No")
                                                                            {
                                                                                $checked = "checked='checked'";
                                                                        ...
                                                                        <div class="switch">
                                                                            <label>
                                                                                Yes
                                                                                <input type="checkbox" name="doyhwasmach" id="doyhwasmach" <?= $checked ?>>
                                                                                <span class="lever"></span>
                                                                                No
                                                                            </label>
                                                                            <?= form_error('doyhwasmach'); ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-11">
                                                                    <div class="form-group">
                                                                        <label> 15) Do you have Drying Machine?</label>   

                                                                        <?php
                                                                        //echo "<br>-486--$doyhdrma---";
                                                                        $checked = "";
                                                                        ...
                                                                        <div class="switch">
                                                                            <label>
                                                                                Yes
                                                                                <input type="checkbox" name="doyhdrma" id="doyhdrma" <?= $checked ?>>
                                                                                <span class="lever"></span>
                                                                                No
                                                                            </label>
                                                                            <?= form_error('doyhdrma'); ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-11">
                                                                    <div class="form-group">
                                                                        <label> 16) Do you have Dishwasher?</label>   

                                                                        <?php
                                                                        // echo "<br>-486--$doyhdish---";
                                                                        $checked = "";
                                                                        ...
                                                                        <div class="switch">
                                                                            <label>
                                                                                Yes
                                                                                <input type="checkbox" name="doyhdish" id="doyhdish" <?= $checked ?>>
                                                                                <span class="lever"></span>
                                                                                No
                                                                            </label>
                                                                            <?= form_error('doyhdish'); ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-11">
                                                                    <div class="form-group">
                                                                        <label> 17) Do you have Electric oven?</label>   

                                                                        <?php
                                                                        // echo "<br>-486--$doyhelov---";
                                                                        $checked = "";
                                                                        ...
                                                                        <div class="switch">
                                                                            <label>
                                                                                Yes
                                                                                <input type="checkbox" name="doyhelov" id="doyhelov" <?= $checked ?>>
                                                                                <span class="lever"></span>
                                                                                No
                                                                            </label>
                                                                            <?= form_error('doyhelov'); ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-11">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label> 18) Do you have Electric water heater?</label>                          
                                                                        <div class="switch">
                                                                            <label>
                                                                                Yes
                                                                                <input type="checkbox" name="dyhewh" id="dyhewh" <?= $checked ?>>
                                                                                <span class="lever"></span>
                                                                                No
                                                                            </label>
                                                                            <?= form_error('dyhewh'); ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-11">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label> 19) Do you use multiple sockets with a switch?</label>                          
                                                                        <div class="switch">
                                                                            <label>
                                                                                Yes
                                                                                <input type="checkbox" name="dyumuswas" id="dyumuswas" <?= $checked ?>>
                                                                                <span class="lever"></span>
                                                                                No
                                                                            </label>
                                                                            <?= form_error('dyumuswas'); ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-11">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label> 20) Do you use natural lighting in sunny days?</label>                          
                                                                        <div class="switch">
                                                                            <label>
                                                                                Yes
                                                                                <input type="checkbox" name="dyunlisd" id="dyunlisd" <?= $checked ?>>
                                                                                <span class="lever"></span>
                                                                                No
                                                                            </label>
                                                                            <?= form_error('dyunlisd'); ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-11">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label> 21) Do you leave the light on in unoccupied room?</label>                          
                                                                        <div class="switch">
                                                                            <label>
                                                                                Yes
                                                                                <input type="checkbox" name="dulloiur" id="dulloiur" <?= $checked ?>>
                                                                                <span class="lever"></span>
                                                                                No
                                                                            </label>
                                                                            <?= form_error('dulloiur'); ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-11">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <?php
// echo "<br>-486--$durecycling---";
                                                                        $checked = "";

                                                                        if (isset($durecycling))
                                                                        {
                                                                            if ($durecycling == "No")
                                                                            {
                                                                                $checked = "checked='checked'";
                                                                        ...
                                                                        <label> 22) Do you do recycling?</label>                          
                                                                        <div class="switch">
                                                                            <label>
                                                                                Yes
                                                                                <input type="checkbox" name="durecycling" id="durecycling" <?= $checked ?>>
                                                                                <span class="lever"></span>
                                                                                No
                                                                            </label>
                                                                            <?= form_error('durecycling'); ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>      
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-11">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <?php
//  echo "<br>-486--$energyeffibulbs---";
                                                                        $checked = "";

                                                                        if (isset($energyeffibulbs))
                                                                        {
                                                                            if ($energyeffibulbs == "No")
                                                                            {
                                                                                $checked = "checked='checked'";
                                                                            }
                                                                        }
                                                                        ...
                                                                        <label> 23) Are you using energy efficiency bulbs/led ?</label>                          
                                                                        <div class="switch">
                                                                            <label>
                                                                                Yes
                                                                                <input type="checkbox" name="energyeffibulbs" id="energyeffibulbs" <?= $checked ?>>
                                                                                <span class="lever"></span>
                                                                                No
                                                                            </label>
                                                                            <?= form_error('energyeffibulbs'); ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div> 
...
if (isset($failedQuestIntoSystem))
{
    ...
    echo "Materialize.toast('An error occurred please try again later', 5000, 'rounded');";
}
?>
